...
namespace FuzzySpeech.Extractor
{
    public class WaveStream : MemoryStream, IDisposable
    {
        ...
        public static MemoryStream CreateMemoryStreamFromFileStream(FileStream fileStream)
        {
            ...
            writer.Write((Int16)waveData.Format.wFormatTag);
            writer.Write((Int16)waveData.Format.nChannels);
            writer.Write((Int32)waveData.Format.nSamplesPerSec);
            writer.Write((Int32)waveData.Format.nAvgBytesPerSec);
            writer.Write((Int16)waveData.Format.nBlockAlign);
            writer.Write((Int16)waveData.Format.wBitsPerSample);
